  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-white">
      <div className="bg-gray-900 rounded-xl shadow-lg p-8 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-amber-300 text-center">Profilim</h2>
        <form onSubmit={handleProfileUpdate} className="mb-8">
          ...
          <button type="submit" className="w-full bg-amber-400 text-black font-bold py-2 rounded hover:bg-amber-500 transition">Bilgilerimi Güncelle</button>
        </form>
        <form onSubmit={handlePasswordChange}>
          <h3 className="text-lg font-semibold mb-2 text-amber-200">Şifre Değiştir</h3>
          <div className="mb-3">
          ...
          <button type="submit" className="w-full bg-amber-400 text-black font-bold py-2 rounded hover:bg-amber-500 transition">Şifreyi Değiştir</button>
        </form>
      </div>
    </div>
  );
